<div>
    @if (!$modal)
        <div
            ...
            <div class="flex flex-col items-center justify-center gap-1 mt-20 xl:flex-row">
                ...
                <div class="flex justify-center gap-1">
                    <div
                        class="items-center justify-center hidden w-6 h-6 text-xl text-center text-white uppercase bg-black border border-gray-700 rounded-md xl:flex md:h-16 md:w-16">
                ...
                @else
                    <div
                        class="flex items-center justify-center w-6 h-6 text-xl text-center text-white uppercase bg-black border border-gray-700 rounded-md md:h-16 md:w-16">
                        @if (in_array($w, $correctLetters))
                            {{ $w }}
                        @endif
                    </div>
...
<div class="absolute bottom-0 left-0 right-0 flex items-center justify-center p-2 top-16">
    <div
        ...
        <div class="flex flex-col items-center justify-start mt-10 mb-5">
            ...
            <h1
                class="text-4xl font-extrabold uppercase @if ($win) text-[#02e659a5] @else text-[#FF3C3C] @endif">
                {{ $word }}
            </h1>
        </div>
