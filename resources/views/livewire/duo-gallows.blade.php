                ...
                <div class="flex flex-col items-start">
                    ...
                    <div class="flex items-center justify-center gap-1">
                        @foreach ($wordArr1 as $w)
                            <div class="flex items-center justify-center w-6 h-6 text-xl text-center text-white uppercase bg-black border border-gray-700 rounded-md md:h-16 md:w-16">
